...
DATA_DIRS = ["/home/user/uploads", os.path.join(_HERE, "data")]
OUT = os.path.join(_HERE, "out")
# fallback naming when candles are fetched in 1000-bar chunks:
#   BTCUSDT-chunk1.csv, btc_usdt-chunk2.csv, ...
CHUNK_RE = re.compile(r"^(?P<sym>[A-Za-z0-9_]+)-chunk\d+\.csv$",
                      re.IGNORECASE)
